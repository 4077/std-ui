...
qq.FileUploader = function (o)
{
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' +
                  '<div class="qq-upload-drop-area"><span>Сбросьте файлы чтобы начать процесс загрузки</span></div>' +
                  '<div class="qq-upload-button">Нажмите или перетащите сюда файлы чтобы загрузить</div>' +
...
//    this._button = this._createUploadButton(this._element);
